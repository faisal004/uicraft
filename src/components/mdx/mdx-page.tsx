...
const components = {
  ...
  h3: (props: React.ComponentProps<"h3">) => (
    <h3 className="mt-10 text-balance text-lg font-medium text-[#10121b]" {...props} />
  ),
  p: (props: React.ComponentProps<"p">) => (
    <p className="mt-4 max-w-2xl text-pretty text-base leading-8 text-[#5d5e62]" {...props} />
  ),
  a: (props: React.ComponentProps<"a">) => (
    <a className="text-[#3155d9] underline decoration-[#3155d9]/25 underline-offset-4 hover:decoration-[#3155d9]" {...props} />
  ),
  ul: (props: React.ComponentProps<"ul">) => (
    <ul className="mt-4 max-w-2xl list-disc space-y-2 pl-5 text-base leading-8 text-[#5d5e62]" {...props} />
  ),
  ol: (props: React.ComponentProps<"ol">) => (
    <ol className="mt-4 max-w-2xl list-decimal space-y-2 pl-5 text-base leading-8 text-[#5d5e62]" {...props} />
  ),
    ...
    return (
      <div className="min-w-0 px-5 py-16 sm:px-10 sm:py-20 lg:px-14 xl:px-20">
        <article className="mx-auto max-w-7xl pb-24">
          <header className="border-b border-[#10121b]/10 pb-16 sm:pb-24">
            <p className="text-sm text-[#3155d9]">A living archive of interface studies</p>
            ...
            <p className="mt-8 max-w-2xl text-pretty text-lg leading-8 text-[#5d5e62] sm:text-xl sm:leading-9">
  ...
  return (
    <div className="min-w-0 px-5 py-10 sm:px-10 sm:py-12 lg:px-14 xl:px-20">
      <article className="mx-auto max-w-6xl pb-24">
        <header className="grid grid-cols-2 border-l border-t border-[#10121b]/10 sm:grid-cols-12 bg-white">
          <div className="flex min-h-16 items-center border-r border-b border-[#10121b]/10 px-4 py-3 sm:col-span-4">
            <p className="text-sm text-[#3155d9]">{eyebrow}</p>
          </div>
          <div className="flex min-h-16 items-center justify-end border-r border-b border-[#10121b]/10 px-4 py-3 sm:col-span-8">
            {document.publishedAt ? (
              <time
                dateTime={document.publishedAt}
                className="font-mono text-xs tabular-nums text-[#10121b]/45"
              >
          ...
          <div className="col-span-2 border-r border-b border-[#10121b]/10 px-5 py-8 sm:col-span-12 sm:px-6 sm:py-10">
            <h1 className="font-heading w-full text-balance text-5xl leading-[0.98] sm:text-5xl lg:text-5xl">
              {document.title}
            </h1>
          </div>
          <div className="col-span-2 flex border-r border-b border-[#10121b]/10 p-5 sm:col-span-12 sm:p-6">
            <p className="max-w-2xl text-pretty text-base leading-7 text-[#5d5e62]">
              {document.description}
            </p>
          </div>
        </header>
          ...
          <>
            <section className="pt-14 sm:pt-20">
              <div className="mb-5 flex items-center justify-between gap-4">
                ...
                <span className="font-mono text-[10px] uppercase text-[#10121b]/40">Interactive</span>
              </div>
